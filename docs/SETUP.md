...
2. Apply migrations 001, 002, 003, 004, 005, 006, and [007](../supabase/migrations/007_admin_user_deletion.sql) in order in Supabase's SQL editor. Apply only missing migrations. Migration 007 enables the super admin's permanent user deletion action; applying it does not delete existing accounts.
